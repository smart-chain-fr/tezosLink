  ...
  <StatusViewStyled>
    <StatusViewContent>
      ...
      <StatusViewHeader>
        ...
        <StatusViewTitle>Proxy service for Testnet is {proxyCarthagenetStatus ? 'online' : 'offline'}.</StatusViewTitle>
        <StatusViewSubtitle>As of {date}.</StatusViewSubtitle>
      </StatusViewHeader>
      <StatusViewHeader>
        {(nodeCarthagenetArchiveStatus && nodeCarthagenetRollingStatus) ? <StatusViewIndicatorGreen /> : <StatusViewIndicatorRed />}
        <StatusViewTitle>Nodes RPC services for Testnet are {(nodeCarthagenetArchiveStatus && nodeCarthagenetRollingStatus) ? 'online' : 'offline'}</StatusViewTitle>
