...
import (
	...
	modelerrors "github.com/smart-chain-fr/tezosLink/backend/pkg/domain/errors"
...
func TestRestController_PostProject_Unit(t *testing.T) {
	...
	p := pkgmodel.NewProject(1, "PROJECT_NAME", "AN_UUID", creationDate, "LIMANET")
...
func TestRestController_GetProject_Unit(t *testing.T) {
	...
	p := pkgmodel.NewProject(123, "A Project", "A_UUID_666", creationDate, "LIMANET")
	...
	assert.Equal(t, `{"data":{"title":"A Project","uuid":"A_UUID_666","network":"LIMANET","metrics":{"requestsCount":3,"requestsByDay":[{"date":"2014-11-1","value":4},{"date":"2014-11-12","value":5}],"rpcUsage":[{"id":"/dummy/path","label":"/dummy/path","value":3}],"lastRequests":["/a/path","/another/path"]}},"status":"success"}`, getStringWithoutNewLine(requestResponse.Body.String()), "Bad body")
}
