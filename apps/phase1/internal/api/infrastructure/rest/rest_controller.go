...
import (
	...
	_ "github.com/smart-chain-fr/tezosLink/backend/internal/api/infrastructure/rest/outputs"
	// Used for the health object to be found by Swagger
	_ "github.com/smart-chain-fr/tezosLink/backend/internal/api/domain/model"
